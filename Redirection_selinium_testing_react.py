...
domain = "exiolot.com"  # Replace with your domain without "http://" or "https://"
...
def determine_expected_redirections(protocol, subdomain, path):
    ...
    if path in ["////////////////horror/", "/blog.html////////////////", "/horror", "/index.php", "/index.html"]:
        # Two-step redirection before reaching final 404 page
        expected_chain.extend([200])  # Last 200 means display of 404.html or equivalent
    else:
